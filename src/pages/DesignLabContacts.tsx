...
export default function DesignLabContacts() {
  ...
  /* ═══ RENDER ═══ */
  return (
    <div className="flex h-screen overflow-hidden select-none" style={{ fontFamily: "'Inter', -apple-system, system-ui, sans-serif", background: C.bg, zoom: SCALE_MAP[textSize] }}>
        ...
        <div className="flex-1 min-h-0 flex">
          <ResizablePanelGroup direction="horizontal" className="h-full">
            ...
            <ResizablePanel defaultSize={65} minSize={30}>
              {sel ? (
                <div className="h-full flex flex-col" style={{ background: C.panel, borderLeft: `1px solid ${C.borderLight}`, borderTop: `2px solid ${SIGNAL_COLORS[sel.signal as keyof typeof SIGNAL_COLORS]?.color ?? C.borderLight}` }}>>
