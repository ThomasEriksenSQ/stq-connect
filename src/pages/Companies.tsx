    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2.5">
        ...
        <div className="flex items-center gap-1.5 flex-wrap">
          <span className="text-[0.6875rem] font-medium uppercase tracking-[0.08em] text-muted-foreground min-w-[80px]">Eier</span>
        ...
        {/* Signal chips */}
        <div className="flex items-center gap-1.5 flex-wrap">
          <span className="text-[0.6875rem] font-medium uppercase tracking-[0.08em] text-muted-foreground min-w-[80px]">Signal</span>
