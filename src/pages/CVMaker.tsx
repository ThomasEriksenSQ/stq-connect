...
export default function CVMaker() {
  ...
  return (
    <div style={{ background: "#d0d0d0", minHeight: "100vh", padding: "24px 0" }}>
      <div
        className="no-print"
        style={{ maxWidth: "210mm", margin: "0 auto 20px auto", display: "flex", alignItems: "center", gap: 12 }}
      >
        <button
          onClick={() => {
          ...
          <div style={{ display: "flex", position: "relative" }}>
              ...
              {(
                ...
                <div key={section.heading} style={{ marginBottom: "5mm" }}>
                  ...
                  {section.items.map((item) => (
                    <div
                      key={item}
                      style={{ display: "flex", gap: "3.2mm", marginBottom: "0.8mm", alignItems: "flex-start" }}
                    >
            ...
            >
              {[
                ...
                <p key={i} style={{ margin: "0 0 4mm 0" }}>
                  {text}
                </p>
              ))}
              ...
              {(
                ...
                <div key={p.company + p.periode} className="cv-project-block" style={{ marginBottom: "6mm" }}>
                  ...
                  >
                    <span>
                      <strong style={{ color: "#1a1a1a" }}>Rolle:</strong> {p.role}
                    </span>
                    <span style={{ flexShrink: 0, marginLeft: "4mm" }}>
                      <strong style={{ color: "#1a1a1a" }}>Periode</strong>: {p.periode}
                    </span>
                  </div>
                  {p.desc.map((d, i) => (
                    <p key={i} style={{ margin: "0 0 3mm 0", lineHeight: 1.46 }}>
                      {d}
                    </p>
                  ))}
