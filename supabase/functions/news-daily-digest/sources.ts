...
const NOISE_HOSTS = /(whothoughtofit|tumblr|blogspot|wordpress\.com|substack\.com|medium\.com|reddit\.com|facebook\.com|twitter\.com|x\.com|pinterest|quora\.com|nordnet\.|inderes\.|investorprat\.|mainsights\.|nordic9\.com|virksomhet\.brreg\.no|euronext\.com|trener\.ai|regnskapstall\.|firmabasen\.|teamtailor\.com|fixrate\.|proff\.no|purehelp\.no|allabolag\.|gulesider\.|1881\.no|finansavisen\.no\/borsmelding|stage\.|sandbox\.)/i;
